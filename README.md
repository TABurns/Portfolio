...
- **Python application engineering** — desktop applications, asynchronous workflows, testing, packaging, and deployment
- **Data engineering** — extraction, transformation, validation, reconciliation, and publishing
- **Analytics** — SQL, KPI development, dashboards, reporting, and decision-support tools
- **Automation and integration** — REST APIs, Domo, SQL Server, file workflows, and external systems

## About This Portfolio

This repository is an index of selected projects. Each project remains in its
